...
/*
DELETE FROM child
FROM RepositoriesContributors AS child
INNER JOIN Repositories AS parent ON child.RepositoryId = parent.Id
WHERE parent.[Name] = 'Softuni-Teamwork'
...
DELETE FROM child
FROM Files AS child
INNER JOIN Commits AS parent ON child.CommitId = parent.Id
INNER JOIN Repositories AS r ON parent.RepositoryId = r.Id
